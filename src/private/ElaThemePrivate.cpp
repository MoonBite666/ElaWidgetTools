...
void ElaThemePrivate::_initThemeColor()
{
    ...
    _darkThemeColorList[DockWidgetBaseEnd] = QColor::fromString("#2a2832");
    ...
    _darkThemeColorList[ElaThemeType::TabBarTabBase] = QColor::fromString("#343a40");//QColor(0x1A, 0x1A, 0x1A);
    _lightThemeColorList[ElaThemeType::TabBarTabHover] = QColor(0xFC, 0xF8, 0xFF);
    _darkThemeColorList[ElaThemeType::TabBarTabHover] = QColor::fromString("#323844");//QColor(0x27, 0x27, 0x27);
    _lightThemeColorList[ElaThemeType::TabBarTabSelected] = Qt::white;
    _darkThemeColorList[ElaThemeType::TabBarTabSelected] = QColor::fromString("#3d424b");//QColor(0x2D, 0x2D, 0x2D);
    ...
    _darkThemeColorList[ElaThemeType::WindowBaseStart] = QColor::fromString("#282c3a");//QColor(0x1A, 0x1A, 0x1A);
    _lightThemeColorList[ElaThemeType::WindowBaseEnd] = QColor(0xF4, 0xF1, 0xF9);
    _darkThemeColorList[ElaThemeType::WindowBaseEnd] = QColor::fromString("#262938");
    ...
    _lightThemeColorList[ElaThemeType::WindowDockWidgetResizeHandle] = QColor::fromString("#829cbc");
    _darkThemeColorList[ElaThemeType::WindowDockWidgetResizeHandle] = QColor::fromString("#6c757d");
    _lightThemeColorList[ElaThemeType::WindowDockWidgetResizeHandleHover] = QColor::fromString("#4cc9f0");
    _darkThemeColorList[ElaThemeType::WindowDockWidgetResizeHandleHover] = QColor::fromString("#84d2f6");
    ...
    _darkThemeColorList[ElaThemeType::WindowTabBarBase] = QColor::fromString("#282c34");
    _lightThemeColorList[ElaThemeType::WindowTabBarHover] = QColor(0xFC, 0xF8, 0xFF);
    _darkThemeColorList[ElaThemeType::WindowTabBarHover] = QColor::fromString("#6c757d");
    _lightThemeColorList[ElaThemeType::WindowTabBarSelected] = Qt::white;
    _darkThemeColorList[ElaThemeType::WindowTabBarSelected] = QColor::fromString("#3d424b");
